    ...
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Text("Equipment Registry", style: GoogleFonts.inter(fontWeight: FontWeight.w800, letterSpacing: -0.5)),
          centerTitle: false,
        ),
        body: Column(
          children: [
              ...
              child: _isLoading && _equipment.isEmpty
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text("No equipment found", style: GoogleFonts.inter(color: Colors.grey.shade500, fontSize: 16, fontWeight: FontWeight.w600)),
                  ],
                ),
              )
                  : RefreshIndicator(
              ...
              child: Form(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        Expanded(child: _buildInputField(ctrl: areaCtrl, label: "Area UUID (Optional)", icon: Icons.place_outlined)),
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton(
                        ...
                        onPressed: () async {
                          ...
                          if (areaCtrl.text.isNotEmpty && areaCtrl.text.length != 36) {
                            ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text('Area ID must be a valid UUID or left blank.', style: GoogleFonts.inter()), backgroundColor: Colors.red));
                            return;
                          }
                          ...
                          try {
                            await _supabase.from('m_equipment').insert({
                              'name': nameCtrl.text,
                              'area_id': areaCtrl.text.isNotEmpty ? areaCtrl.text : null,
      ...
      child: Theme(
        ...
        child: ExpansionTile(
          ...
          leading: Container(
            ...
            decoration: BoxDecoration(color: navy.withOpacity(0.05), borderRadius: BorderRadius.circular(10)),
            child: const Icon(Icons.precision_manufacturing_rounded, color: navy),
          ),
