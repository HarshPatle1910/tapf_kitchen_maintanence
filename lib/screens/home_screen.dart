...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        // Keep the main AppBar fixed at the top
        ...
        // FIX 2: Use CustomScrollView to allow filters to hide/snap on scroll
        body: RefreshIndicator(
          ...
          child: CustomScrollView(
            ...
            slivers: [
              // The floating header for Filters & Search
              SliverAppBar(
                backgroundColor: Colors.white,
                elevation: 0,
                floating: true, // Disappears on scroll down, appears on scroll up
                snap: true,     // Instantly snaps into view on slight scroll up
                automaticallyImplyLeading: false, // Prevents duplicate menu icon
                toolbarHeight: 0,
                bottom: PreferredSize(
                  // FIX: Increased from 150 to 170 to fix the bottom overflow crash!
                            ...
                            Expanded(
                              child: Container(
                                ...
                                child: TextField(
                                  ...
                                  onSubmitted: (value) => context.read<TicketProvider>().setSearchQuery(value),
                            ...
                            InkWell(
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  borderRadius: BorderRadius.circular(12),
                                  border: Border.all(color: hasActiveFilters ? navy : Colors.grey.shade300),
                                  boxShadow: [BoxShadow(color: Colors.black.withOpacity(0.02), blurRadius: 4, offset: const Offset(0, 2))],
                                ),
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () {
                        provider.setFilters(status: tempStatus, priority: tempPriority, start: tempStart, end: tempEnd, sort: tempSort);
                        Navigator.pop(ctx);
                      },
  ...
  Widget _buildSidebar(BuildContext context, bool isAdmin, AuthProvider authProv) {
          ...
          if (isAdmin) ...[
            Padding(
              ...
              child: Align(
                ...
                child: Text("ADMIN CONTROLS", style: GoogleFonts.inter(color: Colors.grey, fontSize: 12, fontWeight: FontWeight.bold, letterSpacing: 1.2)),
              ),
            ),
            ListTile(
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // FIX 1: Wrapped the inner UserDisplays in Expanded so they don't cause a RenderFlex Overflow
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        // FIX 1.5: Make sure the inner Row handles bounds safely by using `Flexible` for the text
        Row(
          mainAxisSize: MainAxisSize.min,
