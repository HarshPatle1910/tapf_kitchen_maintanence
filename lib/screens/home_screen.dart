...
class _HomeScreenState extends State<HomeScreen> {
  ...
  List<Map<String, dynamic>> _kitchenZones =
      []; // Holds zones for the active kitchen
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      if (ticketProvider.kitchenFilter == 'ALL' &&
          authProvider.assignedKitchens.isNotEmpty) {
        final firstKitchenId = authProvider.assignedKitchens.first['id']
            .toString();
  ...
  // Fetch zones associated with the currently selected kitchen
    ...
    try {
      ...
      if (mounted) {
        setState(() {
          ...
          // Map name to display_name for the Autocomplete widget
          for (var z in _kitchenZones) {
  ...
  Widget build(BuildContext context) {
    ...
    // Highlight the tune icon if ANY filter is active
  ...
  // RawAutocomplete Helper for consistent filter dropdown UI
      ...
      optionsViewBuilder: (ctx, onSel, opts) => Align(
        ...
        child: Material(
          ...
          child: Container(
            ...
            ), // Padding adjusted for bottom sheet
            decoration: BoxDecoration(
              color: Colors.white,
              borderRadius: BorderRadius.circular(12),
            ),
  ...
  void _showFilterBottomSheet(
    ...
    // Filters for Autocomplete and toggles
    ...
    // Setup the text controller for the Autocomplete filter
    final zoneSearchController = TextEditingController();
    final zoneFocusNode = FocusNode();

    if (tempZone != 'ALL') {
      final z = _kitchenZones.firstWhere(
                        ...
                        TextButton(
                          onPressed: () {
                            setModalState(() {
                              ...
                              tempStatus = 'ALL';
                              tempZone = 'ALL';
                              zoneSearchController.clear(); // Reset text field
                              tempAssignedToMe = false;
                              tempSort = 'DATE_DESC';
                              tempKitchen = authProv.assignedKitchens.isNotEmpty
                                  ? authProv.assignedKitchens.first['id']
                                        .toString()
                                  : 'ALL';
                              tempStart = null;
                              tempEnd = null;
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: SwitchListTile(
                                ...
                                onChanged: (val) =>
                                    setModalState(() => tempAssignedToMe = val),
                              ),
                            ),
                            const SizedBox(height: 24),

                            // UPDATED: Zone Filter using Autocomplete
                            if (_kitchenZones.isNotEmpty) ...[
                              Text(
                                "Filter by Zone",
                                style: GoogleFonts.inter(
                                  fontWeight: FontWeight.bold,
  ...
  Widget _buildSidebar(
    ...
    if (!authProv.assignedKitchens.any(
                    ...
                    child: DropdownButtonFormField<String>(
                      ...
                      onChanged: (val) {
                        ticketProv.setFilters(
                          kitchenId: val!,
                          zoneId: 'ALL',
                        ); // Reset zone when switching kitchens
                        _fetchZonesForFilter(val);
          ...
          if (isAdmin) ...[
            ...
            ListTile(
              ...
              onTap: () {
                ...
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (_) => const AreaMasterScreen()),
                );
              },
            ),
            ListTile(
            ...
            ListTile(
              ...
              onTap: () {
                ...
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (_) => const KitchenMasterScreen(),
                  ),
                );
              },
            ),
