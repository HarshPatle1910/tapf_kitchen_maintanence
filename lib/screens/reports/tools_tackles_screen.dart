                ...
                Row(
                  children: [
                    ChoiceChip(
                      ...
                      showCheckmark: false,
                      onSelected: (v) =>
                          setDialogState(() => exportMode = 'daily'),
                    ),
                    ...
                    ChoiceChip(
                      ...
                      showCheckmark: false,
                      onSelected: (v) =>
                          setDialogState(() => exportMode = 'monthly'),
                    ),
                  ],
                ),
  ...
  Future<void> _executeExport(
    ...
    try {
      ...
      if (mode == 'daily') {
        ...
        url = Uri.parse(
          '${ApiConstants.pythonApiBaseUrl}/reports/tools/$dateStr?kitchen_id=$targetKitchenId&format=$format',
        );
        ...
        // --- ADDED KITCHEN_ID TO URL ---
        url = Uri.parse(
          '${ApiConstants.pythonApiBaseUrl}/reports/tools/monthly/$monthStr?kitchen_id=$targetKitchenId&format=$format',
        );
                    ...
                    child: filteredTools.isEmpty
                        ...
                        : ListView.separated(
                            ...
                            itemBuilder: (ctx, i) {
                              ...
                              final toolHistory = _logs
                                  .where((l) => l['tool_name'] == toolName)
                                  .toList();
                              final bool isAvailable =
                                  toolHistory.isEmpty ||
                                  toolHistory.first['return_time'] != null;
                              final String currentHolder = !isAvailable
                                  ? toolHistory.first['employee_name'] ??
                                        'Unknown'
                                  : '';
