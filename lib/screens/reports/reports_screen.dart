                      ...
                      Row(
                        children: [
                          Container(
                            ...
                            child: Text(
                              code,
                              style: GoogleFonts.inter(color: primary, fontSize: 10, fontWeight: FontWeight.bold),
                            ),
                          ),
      ...
      body: ListView(
        ...
        children: [
          _buildReportCard(
            ...
            code: "MNT-02",
            desc: "Complete master list of all kitchen machinery and equipment.",
            icon: Icons.precision_manufacturing_outlined,
            onTap: () => Navigator.push(context, MaterialPageRoute(builder: (_) => const EquipmentReportScreen())),
          ),
          _buildReportCard(
            ...
            onTap: () => Navigator.push(context, MaterialPageRoute(builder: (_) => const TestingEquipmentScreen())),
          ),
          _buildReportCard(
            title: "PM Checklist",
            code: "MT-06",
            ...
            onTap: () => Navigator.push(context, MaterialPageRoute(builder: (_) => const PMChecklistScreen())),
          ),
          _buildReportCard(
            title: "Breakdown Intimation",
            code: "MT-07",
            desc: "Register and track sudden machinery breakdowns and resolutions.",
            icon: Icons.warning_amber_rounded,
            onTap: () => Navigator.push(context, MaterialPageRoute(builder: (_) => const BreakdownReportScreen())),
          ),
          _buildReportCard(
            title: "Tools & Tackles",
            code: "MT-08",
            ...
            onTap: () => Navigator.push(context, MaterialPageRoute(builder: (_) => const ToolsTacklesScreen())),
          ),
          _buildReportCard(
            ...
            onTap: () => Navigator.push(context, MaterialPageRoute(builder: (_) => const ComplaintReportScreen())),
          ),
