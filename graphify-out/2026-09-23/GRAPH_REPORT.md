...
- web_excel_verification_table.dart
- Point
- FlutterMacOS
- AppDelegate
...
- ADR-012: Web Excel Spreadsheet View for Dual Sign-Off Ticket Audit Station
- GEMINI.md
...
Cohesion: 0.08
Nodes (23): IconData, background, badgeColor, badgeText, build, _buildDetailRow, _buildEditTextField, _buildMenuCard (+15 more)
...
Cohesion: 0.05
Nodes (41): build, build, build, _activities, _addEmptyActivityRow, background, build, _checklists (+33 more)
...
Cohesion: 0.05
Nodes (41): Animation, AnimationController, _AnimatedTableRow, _AnimatedTableRowState, _animation, animationGeneration, _buildDataCell, _buildHeaderCell (+33 more)

### Community 29 - "Application Flow & Architecture Map - Kitchen Maintenance"
Cohesion: 0.12
Nodes (16): 1. App Initialization, Declarative Routing & Remote Version Enforcement, 2. Authentication & Authorization State Machine (Reactive Navigation Guards), 3. Main Workspace & Kitchen Switching Flow, 4. Ticket Lifecycle & State Transitions, 5. Search, Filter, Sorting & Concurrency Sequencing, 6. Ticket Verification & Dual Presentation Flow (Zone-Based), 7. Media Upload & Storage Pipeline, 8. External Integrations & Push Notifications (+8 more)

### Community 30 - "StatefulWidget"
Cohesion: 0.08
Nodes (24): HomeScreen, _HomeTicketView, ZoneMasterScreen, _ZoneMasterScreenState, BoilerLogListScreen, _BoilerLogListScreenState, DGLogListScreen, _DGLogListScreenState (+16 more)

### Community 31 - "tools_tackles_screen.dart"
Cohesion: 0.10
Nodes (20): ../core/constants/api_constants.dart, background, build, createState, dispose, _executeExport, _fetchData, initState (+12 more)
...
Cohesion: 0.11
Nodes (17): int?, background, build, createState, EquipmentReportScreen, initState, _minimalDecor, _months (+9 more)
...
Cohesion: 0.10
Nodes (37): ChangeNotifier, createAppRouter, AuthProvider, TicketProvider, build, _fetchKitchenZones, initState, _fetchKitchenZones (+29 more)
...
Cohesion: 0.15
Nodes (12): Color, color, _formatDate, _getPriorityInfo, _getStatusColor, isRight, label, name (+4 more)
...
Cohesion: 0.11
Nodes (17): AppTheme, primaryBlue, build, golden, navy, build, currentStatus, build (+9 more)
...
Cohesion: 0.15
Nodes (13): _SplashScreen, PendingApprovalScreen, _EquipmentCard, _InfoItem, ForceUpdateScreen, ResponsiveSidebar, TicketCard, TicketStatusBanner (+5 more)
...
### Community 61 - "web_excel_verification_table.dart"
Cohesion: 0.04
Nodes (48): adminColor, allocatedZones, assignedKitchens, build, _buildColumnHeaderGrid, _buildDataRow, _buildEmptySheetPlaceholder, _buildExcelRibbonHeader (+40 more)
...
### Community 79 - "kitchen_screen.dart"
Cohesion: 0.13
Nodes (15): FormState, background, build, createState, _fetchKitchens, golden, initState, _isLoading (+7 more)

### Community 80 - "spare_inventory_screen.dart"
Cohesion: 0.05
Nodes (37): _addQtyController, background, build, createState, _currentQty, dispose, _fetchInventoryData, _formKey (+29 more)

### Community 82 - "ADR-012: Web Excel Spreadsheet View for Dual Sign-Off Ticket Audit Station"
Cohesion: 0.40
Nodes (5): ADR-012: Web Excel Spreadsheet View for Dual Sign-Off Ticket Audit Station, Consequences, Context, Decision, Status
...
## Knowledge Gaps
- **1323 isolated node(s):** `ApiConstants`, `isProduction`, `_railwayUrl`, `_localIp`, `rootNavigatorKey` (+1318 more)
